...
public class FindAllEmplTicketsDAO {
	private static DataBaseConnect connect;
	static {
		connect = new DataBaseConnect();
	}	
	public static List<ReimbursementTicket> findAll(long status, long user){
		final String SQLQUERY = "SELECT * FROM ers_reimbursement WHERE reimb_status_id = ? and reimb_autor = ?";
