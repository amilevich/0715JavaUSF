...
public class QuesTwelve {
	...
	public static int arrayEven(int num) { // create method arrayEven with argument int num
		...
		for(int i = 0; i < arrEven.length; i++) arrEven[i] = i; // create loop for put all number inside of our array
		for(int i: arrEven) if(arrEven[i] % 2 == 0) System.out.print(arrEven[i] + " "); // check if number is even then print it out		
