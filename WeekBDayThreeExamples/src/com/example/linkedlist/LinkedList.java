...
public class LinkedList {
	 ...
	 * class. The LinkedList class contains a reference of Node class type. Singly
	 * Linked List.
	 */
	...
	public static LinkedList deleteByKey(LinkedList list, int key) {
		...
		while(currNode != null && currNode.data != key) {
			//searching for the key to be deleted, keep track
			//of the previous node as it is needed to change
			//currNode.next
		...
		//therefore the currNode shouldn't be null
		if(currNode != null) {
	...
	public static void main(String[] args) {
		...
		deleteByKey(list, 36);
		printList(list);
		//you can pass in the printList as an argument to deleteByKey DevonTM
		deleteByKey(list, 1);
		printList(list);
		deleteByKey(list, 99);
		printList(list);
