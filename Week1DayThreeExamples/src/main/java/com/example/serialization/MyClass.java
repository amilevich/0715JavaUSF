...
public class MyClass {
	...
	/*
	 * Serialization - is the mechanism of converting the state(s) of an
	 * object into byte stream and persisting in a text file
	 * 
	 * Deserialization - reverse process, byte stream is used to 
	 * recreate the actual Java object in memory
	 * 
	 * To make this happen:
	 * Serializable interface - marker interface (interface with 0 methods)
	...
	public static void main(String[] args) {
		...
		Cereal cereal = new Cereal("Trix", "rainbow", 500, true);
		writeObject(filename, cereal);
		readObject(filename);
	}
