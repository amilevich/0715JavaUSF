...
//		}
	...
	static void  accessSystem() {
		...
		do {
			...
			System.out.println("2 -> Employee Enroll.       ");
	...
	static void menuEmployee() {
			...
			do {
				pullAll.pullAll();
				System.out.println("1 -> Applications to review ");
				System.out.println("2 -> Joint Accounts ");
				System.out.println("3 -> Custumer Information ");				
				...
				switch(option) {
					...
					clc.cnncel();
							break;
					default: if(option != 8)  System.out.println("No is a valid option");
				}
