...
public class CoreStarter
{
	...
	public CoreStarter()
	{
		...
		accountManager = serializer.am;
		userManager = serializer.um;
	...
	void finish()
	{
		serializer.store(userManager, accountManager);
	}
	...
	{
		User[] owners = { account.getPrimaryOwner(), account.getJointOwner() };
		return owners;
	}
