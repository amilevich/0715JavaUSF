...
public class Ticket {
	...
	public String toString() {
		return "Ticket [reimbId=" + reimbId + ", reimbAmount=" + reimbAmount + ", reimbSubmitted=" + reimbSubmitted
				+ ", reimbResolved=" + reimbResolved + ", reimbDescription=" + reimbDescription + ", blob=" + blob
				+ ", reimbAuthor=" + reimbAuthor + ", reimbResolver=" + reimbResolver + ", reimbstatusId="
				+ reimbstatusId + ", reimbtypeId=" + reimbtypeId + ", firstName=" + firstName + ", lastName=" + lastName
				+ "]";
	}
