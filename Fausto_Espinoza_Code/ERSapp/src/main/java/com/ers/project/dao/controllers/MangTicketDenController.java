...
public class MangTicketDenController {
	final static Logger loggy = Logger.getLogger(MangTicketAprController.class);
	public static String GetTicketsDend(HttpServletRequest request, HttpServletResponse response) {
		loggy.info("Get tickets");
...
//		System.out.println(users);
		...
		return "/html/PastHistoryDeny.html";
	}
