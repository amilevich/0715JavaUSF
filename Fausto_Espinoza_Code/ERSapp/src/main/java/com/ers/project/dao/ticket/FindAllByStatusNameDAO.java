...
public class FindAllByStatusNameDAO {
	private static DataBaseConnect connect;
	static {
		connect = new DataBaseConnect();
	}	
	public static List<Ticket> findAll(long status){
		final String SQLQUERY = "SELECT a.*, b.user_first_name, b.user_last_name FROM ers_reimbursement a, ers_users b  WHERE  a.reimb_autor = b.ers_users_id and reimb_status_id = ?";
		...
		try {
			...
			while(rs.next()) {
				...
				ticket.setFirstName(rs.getString(11));
				ticket.setLastName(rs.getString(12));
