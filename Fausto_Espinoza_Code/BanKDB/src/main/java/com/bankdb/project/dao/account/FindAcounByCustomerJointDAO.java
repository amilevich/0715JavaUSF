...
public class FindAcounByCustomerJointDAO {
	static DataBaseConnect dbConn = new DataBaseConnect();
	static Connection conn;
	public List<Account> findAllAccounts(Person person, String typeAccount, String jType){
		final String SQLQUERY = "SELECT a.* FROM account a, jointaccount b WHERE"
				...
				+ " and b.status = ? ORDER BY a.accountnumber ASC";
