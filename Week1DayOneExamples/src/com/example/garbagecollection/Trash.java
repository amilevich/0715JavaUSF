...
public class Trash {
	...
	public static void main(String[] args) {
		...
		o3 = new Object();
		//checkpoint 4: garbage collection -> the old instance is gone
		
		System.gc(); //call the GC
		
		//finalize()
		/*
		 * method that allows to close any connections or perform
		 * any clean up activities before the garbage collector 
		 * comes by
		 */
	}
