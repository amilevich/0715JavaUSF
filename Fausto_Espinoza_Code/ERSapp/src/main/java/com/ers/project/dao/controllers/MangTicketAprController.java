...
public class MangTicketAprController {
	final static Logger loggy = Logger.getLogger(MangTicketAprController.class);
	public static String GetTicketsAprb(HttpServletRequest request, HttpServletResponse response) {
		loggy.info("Managertickets");
